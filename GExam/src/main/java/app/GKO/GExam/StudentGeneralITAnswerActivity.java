 ...
 */
public class StudentGeneralITAnswerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Exam", "ID = " + strID + "Class = " + strClass + "NameAndSurname = " + strNameSurname);
        ...
        Cursor CursorRow = mSqLiteDatabase.rawQuery("SELECT * FROM general_question_TABLE", null);
    ...
    private void NextAlertAfter() {
        ...
        objAlert.setPositiveButton("Thank You too", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent objIntent = new Intent(StudentGeneralITAnswerActivity.this, ExitAcitivity.class);
...
//                NextAlertAfter();
    ...
    public void AddScoreToMySQL() {
        ...
        try {
            ...
            HttpPost objHttpPost = new HttpPost("http://gko-dev.netau.net/Exam/php_add_score2.php");
...
}   //  end of StudentGeneralITAnswerActivity

 ...
 */
public class ClassListGeneralIT extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn3it1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent objIntent3it1 = new Intent(ClassListGeneralIT.this, ListGeneralStudentActivity.class);
        ...
        btn3it2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent objIntent3it2 = new Intent(ClassListGeneralIT.this, ListGeneralStudentActivity.class);
        ...
        btn3it3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent objIntent3it3 = new Intent(ClassListGeneralIT.this, ListGeneralStudentActivity.class);
        ...
        btn3com.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent objIntent3com = new Intent(ClassListGeneralIT.this, ListGeneralStudentActivity.class);

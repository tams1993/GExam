...
public class TabsGeneralITActivity extends Activity {

    TabHost mTabHost;
    private SQLiteDatabase mSqLiteDatabase;
    private ScoreSmallScaleTable objScoreSmallScaleTable;
    private SimpleCursorAdapter objAdapter, objAdapterScore, objAdapterID;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor CursorSmallScale3IT1 = mSqLiteDatabase.rawQuery("SELECT * FROM score_generalit_TABLE WHERE Class ='3IT-1' ", null);
        ...
        List3IT1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent objIntent = new Intent(TabsGeneralITActivity.this, InfoStudentActivity.class);
        ...
        objScoreSmallScaleTable = new ScoreSmallScaleTable(this);
        Cursor CursorSmallScale3IT2 = mSqLiteDatabase.rawQuery("SELECT * FROM score_generalit_TABLE WHERE Class ='3IT-2' ", null);
        ...
        objScoreSmallScaleTable = new ScoreSmallScaleTable(this);
        Cursor CursorSmallScale3IT3 = mSqLiteDatabase.rawQuery("SELECT * FROM score_generalit_TABLE WHERE Class ='3IT-3' ", null);
        ...
        objScoreSmallScaleTable = new ScoreSmallScaleTable(this);
        Cursor CursorSmallScale3COM = mSqLiteDatabase.rawQuery("SELECT * FROM score_generalit_TABLE WHERE Class ='3COM' ", null);

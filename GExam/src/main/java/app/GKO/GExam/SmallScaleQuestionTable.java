 ...
 */
public class SmallScaleQuestionTable {

    private OpenHelper objOpenHelper;
    private SQLiteDatabase writeSQLite, readSQLite;

    public static final String TEACHER_QUESTION_TABLE = "teacher_question_TABLE";
    ...
    public SmallScaleQuestionTable(Context context) {
    ...
    public long AddDataQuestionToSQLite(String strQuestion, String strChoice1, String strChoice2, String strChoice3, String strChoice4, String strTrueAnswer) {

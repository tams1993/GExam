 ...
 */
public class TeacherUserTable {

    private OpenHelper objOpenHelper;
    private SQLiteDatabase writeSQLite, readSQLite;

    public static final String Table_User = "teacher_user_TABLE";
    public static final String COLUMN_ID = "_id";
    public static final String COLUMN_USER = "User";
    public static final String COLUMN_PASSWORD = "Password";

    public TeacherUserTable(Context context) {
    ...
    public String[] AuthenTeacherUser(String strUser) {
    ...
    public long AddTeacherUserToSQLite(String strUser, String strPassword) {

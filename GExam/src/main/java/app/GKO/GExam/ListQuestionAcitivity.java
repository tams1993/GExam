 ...
 */
public class ListQuestionAcitivity extends ListActivity {
...
//        }
        ...
        Cursor QuestionList = objSmallScaleQuestionTable.ReadAllData();
        String[] form = new String[]{SmallScaleQuestionTable.COL_QUESTION};
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent objIntent = new Intent(ListQuestionAcitivity.this, InfoQuestionActivity.class);

        strQuestion = selectItem.getString(selectItem.getColumnIndex(SmallScaleQuestionTable.COL_QUESTION));
        strChoice1 = selectItem.getString(selectItem.getColumnIndex(SmallScaleQuestionTable.COL_CHOICE1));
        strChoice2 = selectItem.getString(selectItem.getColumnIndex(SmallScaleQuestionTable.COL_CHOICE2));
        strChoice3 = selectItem.getString(selectItem.getColumnIndex(SmallScaleQuestionTable.COL_CHOICE3));
        strChoice4 = selectItem.getString(selectItem.getColumnIndex(SmallScaleQuestionTable.COL_CHOICE4));
        strCorrectAnswer = selectItem.getString(selectItem.getColumnIndex(SmallScaleQuestionTable.COL_TRUEANSWER));
